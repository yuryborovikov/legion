...
Check feedback gathering
    ...
    Send feedback data      ${HOST_PROTOCOL}://feedback-${TEST_ENCLAVE}.${HOST_BASE_DOMAIN}   ${feedback_tag}  a=0
...
Check feedback processing
    ...
    Send feedback data      ${HOST_PROTOCOL}://feedback-${TEST_ENCLAVE}.${HOST_BASE_DOMAIN}   ${feedback_tag}  a=${a_value}
