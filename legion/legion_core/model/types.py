...
class ColumnInformation:
    ...
    def __init__(self, representation_type, numpy_type=None):
        ...
        :type representation_type: :py:class:`legion_core.types.BaseType`
    ...
    def representation_type(self):
        ...
        :return: :py:class:`legion_core.types.BaseType`
        """
...
def deduct_types_on_pandas_df(data_frame, extra_columns=None):
    ...
    :type extra_columns: dict[str, :py:class:`legion_core.types.BaseType`] or None
    :return: dict[str, :py:class:`legion_core.types.ColumnInformation`]
    """
    types = {}
...
def build_df(columns_map, input_values, return_dict=False):
    ...
    :type columns_map: dict[str, :py:class:`legion_core.types.ColumnInformation`] or None
