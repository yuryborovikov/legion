...
class TestModelContainer(unittest2.TestCase):
    def test_model_pack_unpack(self):
        ...
        try:
            ...
            legion_pyserve.io.export_df(apply, df, filename=path, prepare_func=prepare, version=version)
            ...
            with legion.io.ModelContainer(path) as container:
                ...
                self.assertIsInstance(random_column, legion_core.model.types.ColumnInformation,
