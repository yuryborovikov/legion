...
import legion_core.model.client
...
class TestModelClient(unittest2.TestCase):
    ...
    def test_image_loading(self):
        ...
        result = legion_core.model.client.load_image(image)
    ...
    def test_client_building(self):
        client = legion_core.model.client.ModelClient(self.MODEL_ID, 'localhost')
    ...
    def test_client_building_relative(self):
        client = legion_core.model.client.ModelClient(self.MODEL_ID, use_relative_url=True)
    ...
    def test_client_building_from_env(self):
        with patch_environ({legion.config.MODEL_SERVER_URL[0]: 'test:10'}):
            client = legion_core.model.client.ModelClient(self.MODEL_ID)
