...
@blueprint.route(legion_core.model.urls.SERVE_ROOT)
def root():
    """
...
@blueprint.route(legion_core.model.urls.SERVE_INFO.format(model_id='<model_id>'))
...
@blueprint.route(legion_core.model.urls.SERVE_INVOKE.format(model_id='<model_id>'), methods=['POST', 'GET'])
...
@blueprint.route(legion_core.model.urls.SERVE_HEALTH_CHECK)
def healthcheck():
    """
